...
if user_defined_filter:
    red_laser = TrackTools.LaserTracker(hsv_lower, hsv_upper, t_matrix, 100)
else:
    red_laser = TrackTools.LaserTracker(red_lower, red_upper, t_matrix, 100)
